    ...
    <header className="bg-primary text-white w-full">
      <nav className="max-w-full px-8 py-4 flex justify-between items-center">
        ...
        <div className="flex gap-4 relative right-20">
          <Link to={"/login"}>
            <button className="border border-white h-11 px-6 rounded-[5px] hover:bg-white hover:cursor-pointer hover:text-primary transition">
              Sign In
            </button>
          </Link>
          <Link to={"/register"}>
            <button className="bg-white text-primary h-11 px-6 rounded-[5px] hover:bg-gray-300 hover:cursor-pointer transition">
              Sign Up
            </button>
          </Link>
        </div>
