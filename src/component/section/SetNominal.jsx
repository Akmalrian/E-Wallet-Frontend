  ...
  return (
    <section className="mt-6 text-[16px] font-montserrat">
      ...
      <div className="ml-4 flex items-center gap-4 mb-8">
        <img src="/public/image/number1black.svg" alt="icon number 1" />
        <p>Find People</p>
        <img src="/public/image/VectorDotted.svg" alt="vector dotted" />
        <img src="/public/image/number2blue.svg" alt="icon number 2" />
        <p>Set Nominal</p>
        <img src="/public/image/VectorDotted.svg" alt="vector dotted" />
          ...
          <div className="ml-10 mr-10">
            <div className="flex justify-between items-center h-28.75 w-full p-4 bg-[#E8E8E84D] ">
              <div className="flex items-center">
                <img className="w-20 h-20" src="/public/image/historyPhoto.svg" alt="Ghaluh Photo" />
              ...
              <img className="w-6 h-6" src="/public/image/Star.svg" alt="icon star" />
            </div>
